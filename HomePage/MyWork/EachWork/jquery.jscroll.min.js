...
! function (a) {
    ...
    a.jscroll = {
        defaults: {
            ...
            autoTrigger: !0,
            autoTriggerUntil: !1,
            loadingHtml: "<small>If the document stops here, the browser requires the document to be accessed via a webserver e.g. http://localhost:8000 due to security purposes. Inspect and read about error message for more details. </small>",
            loadingFunction: !1,
            padding: 0,
            nextSelector: "a:last",
            contentSelector: "",
